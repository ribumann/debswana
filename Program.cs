...
namespace SendSampleData
{
    class Program
    {
        const string eventHubName = "kustohub";
        // Copy the connection string ("Connection string-primary key") from your Event Hub namespace.
        const string connectionString = @"Endpoint=sb://kustohub.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=BhdrQKfYojvrPEzq4MYEGOh9cyJUi5ziY+bwGVExoCI=";
